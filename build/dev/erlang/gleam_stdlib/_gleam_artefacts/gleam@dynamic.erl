...
-spec optional(fun((dynamic()) -> {ok, CPE} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        gleam@option:option(CPE)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-spec result(
    fun((dynamic()) -> {ok, COS} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, COU} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {ok, COS} | {error, COU}} |
    {error, list(decode_error())}).
...
-spec any(list(fun((dynamic()) -> {ok, CSD} | {error, list(decode_error())}))) -> fun((dynamic()) -> {ok,
        CSD} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec list(fun((dynamic()) -> {ok, COZ} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        list(COZ)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
) -> fun((dynamic()) -> {ok, gleam@option:option(CPN)} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CQD, CQF}} | {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CQI, CQK, CQM}} | {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CQP, CQR, CQT, CQV}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CQY, CRA, CRC, CRE, CRG}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, gleam@map:map_(CRW, CRY)} |
    {error, list(decode_error())}).
...
-spec decode6(
    fun((CTV, CTW, CTX, CTY, CTZ, CUA) -> CUB),
    fun((dynamic()) -> {ok, CTV} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CTW} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CTX} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CTY} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CTZ} | {error, list(decode_error())}),
...
-spec decode7(
    fun((CUJ, CUK, CUL, CUM, CUN, CUO, CUP) -> CUQ),
...
-spec decode8(
    fun((CUZ, CVA, CVB, CVC, CVD, CVE, CVF, CVG) -> CVH),
...
-spec decode9(
    fun((CVR, CVS, CVT, CVU, CVV, CVW, CVX, CVY, CVZ) -> CWA),
