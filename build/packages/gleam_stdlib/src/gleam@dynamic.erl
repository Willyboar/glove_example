...
-spec decode1(
    fun((BWE) -> BWF),
    fun((dynamic()) -> {ok, BWE} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BWF} | {error, list(decode_error())}).
...
-spec optional(fun((dynamic()) -> {ok, BTB} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        gleam@option:option(BTB)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-spec result(
    fun((dynamic()) -> {ok, BSP} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BSR} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {ok, BSP} | {error, BSR}} |
    {error, list(decode_error())}).
...
-spec any(list(fun((dynamic()) -> {ok, BWA} | {error, list(decode_error())}))) -> fun((dynamic()) -> {ok,
        BWA} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec map_errors(
    {ok, BRZ} | {error, list(decode_error())},
...
-spec list(fun((dynamic()) -> {ok, BSW} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        list(BSW)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-spec field(
    any(),
    fun((dynamic()) -> {ok, BTG} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BTG} | {error, list(decode_error())}).
...
-spec optional_field(
    any(),
    fun((dynamic()) -> {ok, BTK} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, gleam@option:option(BTK)} |
    {error, list(decode_error())}).
...
-spec element(
    integer(),
    fun((dynamic()) -> {ok, BTO} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BTO} | {error, list(decode_error())}).
...
-spec tuple2(
    fun((dynamic()) -> {ok, BUA} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUC} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {BUA, BUC}} | {error, list(decode_error())}).
...
-spec tuple3(
    fun((dynamic()) -> {ok, BUF} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUH} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUJ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {BUF, BUH, BUJ}} | {error, list(decode_error())}).
...
-spec tuple4(
    fun((dynamic()) -> {ok, BUM} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUO} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUQ} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUS} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {BUM, BUO, BUQ, BUS}} |
    {error, list(decode_error())}).
...
-spec tuple5(
    fun((dynamic()) -> {ok, BUV} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUX} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BUZ} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVB} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVD} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {BUV, BUX, BUZ, BVB, BVD}} |
    {error, list(decode_error())}).
...
-spec tuple6(
    fun((dynamic()) -> {ok, BVG} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVI} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVK} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVM} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVO} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVQ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {BVG, BVI, BVK, BVM, BVO, BVQ}} |
    {error, list(decode_error())}).
...
-spec map(
    fun((dynamic()) -> {ok, BVT} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BVV} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, gleam@map:map_(BVT, BVV)} |
    {error, list(decode_error())}).
...
-spec decode2(
    fun((BWI, BWJ) -> BWK),
    fun((dynamic()) -> {ok, BWI} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BWJ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BWK} | {error, list(decode_error())}).
...
-spec decode3(
    fun((BWO, BWP, BWQ) -> BWR),
    fun((dynamic()) -> {ok, BWO} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BWP} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BWQ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BWR} | {error, list(decode_error())}).
...
-spec decode4(
    fun((BWW, BWX, BWY, BWZ) -> BXA),
    fun((dynamic()) -> {ok, BWW} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BWX} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BWY} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BWZ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BXA} | {error, list(decode_error())}).
...
-spec decode5(
    fun((BXG, BXH, BXI, BXJ, BXK) -> BXL),
    fun((dynamic()) -> {ok, BXG} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXH} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXI} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXJ} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXK} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BXL} | {error, list(decode_error())}).
...
-spec decode6(
    fun((BXS, BXT, BXU, BXV, BXW, BXX) -> BXY),
    fun((dynamic()) -> {ok, BXS} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXT} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXU} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXV} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXW} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BXX} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BXY} | {error, list(decode_error())}).
...
-spec decode7(
    fun((BYG, BYH, BYI, BYJ, BYK, BYL, BYM) -> BYN),
    fun((dynamic()) -> {ok, BYG} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYH} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYI} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYJ} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYK} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYL} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYM} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BYN} | {error, list(decode_error())}).
...
-spec decode8(
    fun((BYW, BYX, BYY, BYZ, BZA, BZB, BZC, BZD) -> BZE),
    fun((dynamic()) -> {ok, BYW} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYX} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYY} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BYZ} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZA} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZB} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZC} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZD} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BZE} | {error, list(decode_error())}).
...
-spec decode9(
    fun((BZO, BZP, BZQ, BZR, BZS, BZT, BZU, BZV, BZW) -> BZX),
    fun((dynamic()) -> {ok, BZO} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZP} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZQ} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZR} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZS} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZT} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZU} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZV} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, BZW} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, BZX} | {error, list(decode_error())}).
